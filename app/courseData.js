export const courseData = {
    'UTC2118': {
        ...
        assignment: 'Hands-on practical experience with some of the forensic techniques, Students will select a topic related to forensic science techniques and discuss the challenges in the interpretation and validity of forensic evidence in the justice system. Students will also be presented a mock crime scene to follow through the crime and allow them to experience the crime scene investigation techniques, collecting evidence, reconstructing the crime scene activity and presenting the evidence to “court”.',
    },
    'UTC2109/UTS2109': {
    ...
    'UTS2103/UTC2103': {
        ...
        assignment: 'Students can expect a mixture of individual assignments (e.g., medical narrative; learning journal) and group assignments (e.g., Model United Nations conference; interdisciplinary research project).',
    },
    'UTC2102': {
        name: 'Climate Change',
    ...
    'UTC2113': {
        ...
        assignment: 'Actual games will be played each week. These games will encourage students to draw parallels between the reading and the game—its rules and players, but also ways to cheat or spoil the game. Students can expect to work creatively and flexibly as they read into the game. Students will select a topic or game to present on in pairs. The presentation involves examining the experience—that is to say, the emotional, cognitive, affective, performative, technical nature—of the game. Students will take note of moments when a connection between the concept or theory and the playing out of that during the activity is made. Students will then embark on a work of their choice. The work involves students proposing a question or thesis, and responding to it in the form or medium of their choosing. In other words, they will set the rules according to which the game will be played and through which the game will judge them. To prepare them for this open-ended task, students will think through the possibilities of their work by submitting a proposal. At the end of their work, they will come in to defend their works: the parameters they have set and the decisions they have made in the course of their work.',
    },
    'UTS2110/UTC2110': {
